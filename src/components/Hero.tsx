    ...
    <>
      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <div className="w-full max-w-4xl mx-auto">
            <img 
              src="https://cdn.poehali.dev/projects/4a1317c4-a1d1-4ba3-b07b-dca01270381c/files/088dce92-ca79-4b09-971c-c9dd3f44c6fc.jpg" 
      ...
      <section className="relative min-h-screen bg-gray-100 overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-12 relative z-10">
          <h1 className="text-3xl md:text-5xl text-gray-800 mb-6 max-w-3xl font-light">
          ...
          <div className="relative mb-8">
            ...
            <div className="relative z-10 max-w-2xl">
              <h2 className="text-2xl md:text-4xl text-gray-800 mb-4 font-light">
      ...
      <section className="relative min-h-screen bg-purple-600 overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-16 relative z-10 flex flex-col justify-between min-h-screen">
          <div className="max-w-2xl">
            <h2 className="text-3xl md:text-5xl text-white mb-6 font-light">
              ЩЕЛК!
            </h2>
            <p className="text-lg md:text-xl text-white/90 mb-8">
              Мы учим детей извлекать пользу из любой эмоции - или «переключать» ее на ту, которая нужна прямо сейчас.
            </p>
          </div>
      ...
      <section className="relative min-h-screen bg-yellow-500 overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-16 relative z-10 flex flex-col justify-between min-h-screen">
          <div className="max-w-2xl">
            <h2 className="text-3xl md:text-5xl text-gray-900 mb-6 font-light">
              СУПЕРДЕТИ
            </h2>
            <p className="text-lg md:text-xl text-gray-800 mb-8">
              Дети, которые обладают такой силой успешнее остальных во всех сферах.
            </p>
          </div>
      ...
      <section className="relative min-h-screen bg-white overflow-hidden">
        <div className="container mx-auto px-4 py-16 relative z-10">
          <h2 className="text-4xl md:text-6xl text-gray-900 text-center mb-16 font-light">
            ЗАНЯТИЯ
          </h2>
      ...
      <section className="relative min-h-screen bg-white overflow-hidden py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl md:text-6xl text-gray-900 text-center mb-8 font-light">
            КОМАНДА
          </h2>
      ...
      <section className="py-12 bg-gradient-to-b from-purple-500 to-purple-600">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl text-white text-center mb-8 font-light">Родители сообщают</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-xl mx-auto">
            <div className="bg-purple-400 bg-opacity-40 rounded-xl p-3 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl cursor-pointer">
              ...
              <p className="text-white text-sm font-medium">Анна Игнатьева</p>
            </div>
            ...
            <div className="bg-purple-400 bg-opacity-40 rounded-xl p-3 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl cursor-pointer">
              ...
              <p className="text-white text-sm font-medium">Владимир Гришковец</p>
            </div>
            ...
            <div className="bg-purple-400 bg-opacity-40 rounded-xl p-3 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl cursor-pointer">
              ...
              <p className="text-white text-sm font-medium">Анна Сытник</p>
            </div>
            ...
            <div className="bg-purple-400 bg-opacity-40 rounded-xl p-3 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl cursor-pointer">
              ...
              <p className="text-white text-sm font-medium">Анна Ратиани</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50" id="contacts">
        <div className="container mx-auto px-4">
          <div className="max-w-sm mx-auto bg-yellow-400 rounded-2xl shadow-xl p-6">
            <h2 className="text-2xl text-center mb-6 text-gray-800 font-light">
            ...
            <form className="space-y-4" onSubmit={async (e) => {
              ...
              <div className="pt-3">
                <p className="text-xs text-gray-700 text-center mb-3 leading-tight">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <div className="text-center my-8">
                <p className="text-2xl md:text-3xl font-semibold text-gray-900">
                  Стоимость: 1500₽ <span className="text-lg font-light text-gray-600">(онлайн)</span>
                </p>
              </div>
            </div>
